...
OrderDirectionKind = typing.Union[Buy, Sell]
OrderDirectionJSON = typing.Union[BuyJSON, SellJSON]


def from_decoded(obj: dict) -> OrderDirectionKind:
...
def from_json(obj: OrderDirectionJSON) -> OrderDirectionKind:
    if obj["kind"] == "Buy":
        return Buy()
    if obj["kind"] == "Sell":
        return Sell()
